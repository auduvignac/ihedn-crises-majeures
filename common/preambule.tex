...
\let\IhednOriginalSection\section
\RenewDocumentCommand{\section}{s o m}{%
  \Needspace{12\baselineskip}%
  \IfBooleanTF{#1}{%
    \IhednOriginalSection*{#3}%
  }{%
    \IfNoValueTF{#2}{%
      \IhednOriginalSection{#3}%
    }{%
      \IhednOriginalSection[#2]{#3}%
    }%
  }%
}

\let\IhednOriginalSubsection\subsection
\RenewDocumentCommand{\subsection}{s o m}{%
  \Needspace{10\baselineskip}%
  \IfBooleanTF{#1}{%
    \IhednOriginalSubsection*{#3}%
  }{%
    \IfNoValueTF{#2}{%
      \IhednOriginalSubsection{#3}%
    }{%
      \IhednOriginalSubsection[#2]{#3}%
    }%
  }%
}

\let\IhednOriginalSubsubsection\subsubsection
\RenewDocumentCommand{\subsubsection}{s o m}{%
  \Needspace{8\baselineskip}%
  \IfBooleanTF{#1}{%
    \IhednOriginalSubsubsection*{#3}%
  }{%
    \IfNoValueTF{#2}{%
      \IhednOriginalSubsubsection{#3}%
    }{%
      \IhednOriginalSubsubsection[#2]{#3}%
    }%
  }%
}
...
\newcommand*\propositionnumberline[1]{\hb@xt@\@tempdima{\hfil#1\enspace}}
\newcommand*\l@proposition[2]{%
  \begingroup
  \let\numberline\propositionnumberline
  \@dottedtocline{1}{0pt}{6.6em}{#1}{#2}%
  \endgroup
}
\newcommand*\l@subproposition[2]{%
  \begingroup
  \let\numberline\propositionnumberline
  \@dottedtocline{2}{1.5em}{7.8em}{#1}{#2}%
  \endgroup
}
...
\renewcommand{\thesubproposition}{\theproposition.\arabic{subproposition}}
...
\newenvironment{proposition}[1]
{
  ...
  \addcontentsline{lop}{proposition}{%
    \protect\numberline{Proposition~\theproposition.}#1%
  }
...
\newcommand{\propositiongroup}[1]{%
  \refstepcounter{proposition}%
  \setcounter{subproposition}{0}%
  \addcontentsline{lop}{proposition}{%
    \protect\numberline{Proposition~\theproposition.}#1%
  }%
}

\newenvironment{subproposition}[1]
{
  \refstepcounter{subproposition}

  \addcontentsline{lop}{subproposition}{%
    \protect\numberline{Proposition~\thesubproposition.}#1%
  }

  \begin{propositionbox}
  {Proposition~\thesubproposition~: #1}
}
{
  \end{propositionbox}
}
...
\newcommand{\IhednSetPdfPageCount}[2]{%
  ...
  \IfFileExists{\ihedn@pdfpath}{%
    ...
    \PackageError{ihedn-common}
      {PDF file `\ihedn@pdfpath' not found or unreadable}
      {The macro \string\IhednSetPdfPageCount\space was called with\MessageBreak
       a missing or unreadable PDF file.\MessageBreak
       Check the path `\ihedn@pdfpath' and try again.}%
    \global#1=0\relax
  }%
  \endgroup
}
