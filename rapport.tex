...
\addlinespace
Adhérents des associations d'anciens auditeurs & Environ 5\,450 adhérents, dont près de 3\,250 au sein des associations régionales. & Le questionnaire administré aux adhérents ne couvre qu'une fraction minoritaire des anciens auditeurs. \\
\addlinespace
Poids relatif de l'adhésion & Les auditeurs adhérents représenteraient environ 18\,\% de l'ensemble des anciens auditeurs recensés. & Les résultats devront être interprétés comme une mesure du potentiel associatif, non comme une photographie exhaustive de toute la communauté IHEDN. \\
\addlinespace
...
En effet, le nombre des auditeurs inscrits dans les associations (5000) représente 18\,\% du total de ceux qui ont suivi une (ou parfois deux) sessions.
...
Les sessions régionales les plus anciennes présentent des taux d'adhésion particulièrement faibles, tandis que les cohortes récentes conservent un lien associatif plus marqué. L'érosion du taux d'adhésion au cours du temps apparaît ainsi largement comme le reflet du vieillissement des auditeurs, mais également de l'évolution des disponibilités personnelles et professionnelles ainsi que de l'affaiblissement progressif des réseaux de sociabilité issus des sessions.
...
Les associations régionales les plus importantes, c'est-à-dire comptant plus de 100 membres, sont notamment :
\begin{itemize}
    \item l'AR~16 -- Paris--Île-de-France ;
    \item l'AR~15 -- Région lyonnaise (environ 300 membres) ;
    \item l'AR~11 -- Aquitaine (environ 220 membres) ;
    \item l'AR~7 -- Centre-Val de Loire (environ 180 membres) ;
    \item les AR~2 -- Auvergne, 10 -- Franche-Comté, 15 -- Nord et 19 -- Midi-Pyrénées (environ 140 membres) ;
    \item les AR~9 -- Provence et 12 -- Languedoc-Roussillon (environ 120 membres) ;
    \item les AR~6 -- Haute Bretagne, 8 -- Dauphiné-Savoie, 13 -- Lorraine, 18 -- Poitou-Charentes, 21 -- Île-de-France Versailles, 22 -- Alsace et 29 -- Nice Côte d'Azur (environ 100 membres).
\end{itemize}

\clearpage

La figure \ref{fig:ar_principales} propose une représentation visuelle de la répartition des principales associations régionales en fonction de leurs effectifs approximatifs.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/graphe_ar_principales.pdf}
    \caption{Principales associations régionales IHEDN comptant plus de 100 membres.}
    \label{fig:ar_principales}
\end{figure}
