...
Cette situation constitue un frein majeur à toute mobilisation efficace. Par conséquent, la mise en place d'un outil concret est apparue comme une condition requise à l'accomplissement d'une telle mobilisation.
...
Un tel dispositif offrirait en outre des données qualitatives et quantitatives objectivées, de nature à soutenir une implication effective des membres des associations de l'IHEDN. Cette problématique s'inscrit dans la continuité de réflexions antérieures, notamment celles relatives à la création d'une réserve de l'IHEDN, étudiée à la demande d'Édouard Philippe en 2015\footcite{DESAINTSALVY2026}.
...
Dans la perspective de concevoir ce questionnaire, le comité a fait appel à l'expertise du docteur Victor Violier, sociologue à l'\gls{irsem}\footcite{violier_irsem}, afin de s'appuyer sur des fondements méthodologiques robustes et d'en assurer la mise en \oe{}uvre dans des conditions optimales\footnote{Entretien avec le docteur Victor Violier, sociologue à l'IRSEM, réalisé le 20 février 2026}. 
...
Sur la base de l'ensemble des éléments énoncés jusqu'ici, le comité a souhaité également établir un calendrier prévisionnel de mise en \oe{}uvre du questionnaire.
