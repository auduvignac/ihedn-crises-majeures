...
\node[dot] at (8.0,0) {};
\node[event, above=0.65cm] at (8.35,0) {19/05, 21/05, 11/06\\Analyse de l'annuaire 2022, échange sur la fin du projet d'enquête, derniers arbitrages. Dates à vérifier.};
...
\ChronoItems{
    ...
    \item Perspective d'un calendrier prévisionnel après consultation de l'IRSEM.
...
\ChronoItems{
    ...
    \item Date à vérifier au regard de la chronologie générale.
} \\
\addlinespace

\ChronoDate{21/05/2025} &
\ChronoItems{
...
\begin{itemize}[leftmargin=*]
    ...
    \item IRSEM, Étude 70, Sarah Adjel, Angélique Palle et Noémie Rebière, \textit{Risques géopolitiques, crises et ressources naturelles -- Approches transversales et apport des sciences humaines}, septembre 2019.
    \item IRSEM, Étude 95, \textit{L'armée, les Français et la crise sanitaire. Une enquête inédite}, juin 2022.
...
\AlignedCell{Victor Violier, sociologue à l'IRSEM, pôle Défense et société\footnotemark} &
\AlignedBullets{
    ...
    \item Perspective d'une séance de restitution associant l'\ARSeize{} et l'IRSEM.
} &
\AlignedBullets{
...
\AlignedCell{Anne Muxel, directrice déléguée du CEVIPOF, directrice de recherches émérite en sociologie et sciences politiques au CNRS, ancienne directrice du domaine « Défense et société » de l'IRSEM} &
\AlignedBullets{
