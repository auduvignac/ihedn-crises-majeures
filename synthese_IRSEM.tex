...
\PageDeGardeIHEDN{
    ...
    subtitle={Éléments de synthèse relatifs à l'échange avec le Docteur Victor Violier -- Sociologue à l'IRSEM},
...
À terme, une extension à d'autres associations régionales pourrait être explorée.
Toutefois, une telle ambition supposerait des moyens humains et méthodologiques conséquents.
Dans l'immédiat, il est proposé de conduire un sondage ciblé sur l'AR 16, susceptible de constituer un modèle reproductible.

\section{Finalité et justification de l'enquête}

Toute enquête exige d'abord que l'on s'interroge sur sa raison d'être :
\textbf{à quoi est-elle destinée, à qui s'adresse-t-elle et à qui doit-elle servir ?}

Selon le Docteur Violier\footcite{violier_irsem}, l'enquête permet de dépasser
les représentations spontanées et d'introduire une distance analytique.
Elle constitue un instrument d'objectivation.

Dans le contexte du 50\textsuperscript{ème} anniversaire de l'AR 16 Paris-Île-de-France (créée en 1976\footcite{linkedin_AR16}), elle peut également jouer un rôle de plaidoyer institutionnel, en permettant :
...
\begin{enumerate}
    \item Cartographier l'AR 16 pour mieux la faire connaître ;
...
L'élaboration du questionnaire doit être précédée d'une problématique claire.
...
Il est relativement simple de produire des questions ; il est plus exigeant d'en évaluer la pertinence.

Chaque question, qu'elle soit ouverte, fermée ou mixte, doit être justifiée au regard de l'objet de recherche.
De plus, des précautions doivent être prises sur le plan rédactionnel et analytique \textit{a posteriori} afin de
se prémunir contre des écueils tels que l'\enquote{imposition de problématique}
ou l'\enquote{illusion biographique}.
...
\subsection{Prendre garde à l'\enquote{illusion biographique}}
